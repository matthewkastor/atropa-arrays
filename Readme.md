...
```
var arrays = require('atropa-arrays').arrays;
console.log(arrays);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-arrays_web.js` in your page and
 `atropa.arrays` will be available in your page.
...
To run the browser tests open `browser/atropa-arrays_tests.html` in your
...
If you alter the source in `src/atropa-arrays.js` please run the
